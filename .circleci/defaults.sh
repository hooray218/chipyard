...
mapping["firesim"]           ="SCALA_TEST_NAME=firesim.firesim.RocketNICF1Tests"
mapping["firesim-multiclock"]="SCALA_TEST_NAME=firesim.firesim.RocketMulticlockF1Tests"
mapping["fireboom"]          ="SCALA_TEST_NAME=firesim.firesim.BoomF1Tests"
mapping["fireariane"]        ="SCALA_TEST_NAME=firesim.firesim.ArianeF1Tests"
